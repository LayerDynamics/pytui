...
class ScriptExecutor:
    ...
    def start(self):
        ...
        # Add both the tracer module path and package root to Python path
        package_root = Path(__file__).parent.parent.resolve()  # Get root of pytui package
        tracer_module_path = Path(__file__).parent.resolve()
        
        pythonpath = [str(package_root), str(tracer_module_path)]
