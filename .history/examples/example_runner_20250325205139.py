...
EXAMPLES = {
    "basic": "basic_Example.py",  # Capital E to match the actual filename
...
EXAMPLE_DESCRIPTIONS = {
    ...
    "intermediate": "Task management interface with list display and task controls",
    "advanced": "Interactive data dashboard with visual components and async operations",
