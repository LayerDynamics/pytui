...
def _handle_exception_event(_, exc_info, collector):
    """Handle exception events."""
    # Renamed arg to exc_info for clarity, removed unused frame parameter
    ...
    try:
        ...
        if event == "return":
            _handle_return_event(
                arg, frame.f_code.co_name, _state.get_collector()
            )
        return None
