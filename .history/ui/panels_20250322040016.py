...
from textual.scroll_view import ScrollView  # Updated import path - main module
from textual.widgets.tree import Tree  # Updated import for Tree widget
...
class CallGraphPanel(Container):
    ...
    async def on_mount(self):
        ...
        # Using Tree instead of TreeControl for Textual 2.x
        self.tree = Tree("Execution")
