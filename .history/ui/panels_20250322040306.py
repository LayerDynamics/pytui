...
class CallGraphPanel(Container):
    ...
    async def on_mount(self):
        ...
        # Use Rich's Tree instead of Textual's Tree
        self.rich_tree = RichTree("Execution")
        await self.update_tree()
        
    async def update_tree(self):
        """Update the displayed tree."""
        await self.update(Panel(self.rich_tree, title="Call Graph"))
