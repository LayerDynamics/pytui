...
@pytest.mark.slow
def test_error_handling(error_script_fixture):
    """Test handling of scripts with various errors."""
    executor = None
    try:
        executor = ScriptExecutor(error_script_fixture)
        executor.start()
...
@pytest.mark.slow
def test_long_running_script_termination(long_running_script_fixture):
    """Test ability to terminate a long-running script."""
    executor = None
    try:
        executor = ScriptExecutor(long_running_script_fixture)
        executor.start()
...
@pytest.mark.slow
def test_stdout_flood_handling(stdout_flood_script_fixture):
    """Test handling of scripts that flood stdout."""
    executor = None
    try:
        executor = ScriptExecutor(stdout_flood_script_fixture)
        executor.start()
