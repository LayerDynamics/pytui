...
from pytui.tracer import trace_function, install_trace, _get_collector, _should_skip_file
...
@pytest.mark.slow
def test_complex_arguments_tracing(complex_args_script):
    """Test tracing of functions with complex arguments."""
    ...
    try:
        ...
        # Check function call was traced
        complex_func_calls = [
        ...
        # Verify arguments were captured, potentially truncated for large values
        ...
        # Arguments should be truncated if too large
        assert "..." in complex_call.args.get("a_list", ""), "Large list should be truncated"
        
        # Verify function return was captured
...
@pytest.mark.slow
def test_exception_tracing(exception_script):
    """Test tracing of various exception patterns."""
    from pytui.executor import ScriptExecutor
    ...
    try:
        ...
        # Check for expected output that shows exceptions were handled
        ...
        # Check exceptions were captured by the tracer
...
@pytest.mark.slow
def test_module_import_tracing(module_import_script):
    """Test tracing of module imports."""
    from pytui.executor import ScriptExecutor
    ...
    try:
        ...
        # Check use_imports function was traced
        ...
        # Verify expected output indicating imports worked
        outputs = " ".join([line.content for line in executor.collector.output])
