...
def trace_function(frame, event, arg):
    ...
    if event == 'call':
        ...
        # Skip tracing for internal modules and special names, but be more selective
        if (('pytui' in filename and 'tracer.py' in filename) or 
            func_name.startswith('__') or 
            func_name == '<module>'):
            return trace_function  # Return function to continue tracing but skip this frame
