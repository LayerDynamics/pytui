...
import time
from typing import List, Dict, Any, Optional, TypeVar, Union, Callable, Type
...
try:
    ...
    from rich.console import RenderableType, Console  # type: ignore
...
class OutputPanel(BasePanel, ScrollView):
    ...
    def _create_content_panel(self, renderables: List[Any]) -> Any:
        ...
        # Remove unnecessary else and de-indent the code
        # Regular display
...
class LogPanel(BasePanel, ScrollView):
    ...
    def __init__(self):
        ...
        # Group log level related attributes into a single dictionary
        self._log_settings = {
            "levels": {
                "DEBUG": "dim blue",
                "INFO": "green",
