...
class OutputPanel(BasePanel, ScrollView):
    ...
    async def update_content(self):
        ...
        if self.group_by_stream:
            ...
            content = Columns(group_displays) if group_displays else Panel("No output", title="Output")
        else:
            # Regular display
    ...
    def _filter_outputs(self):
        ...
        return [
            ...
            if (hasattr(out, "original_output") and 
                filter_text in out.original_output.content.lower())
    ...
    async def update_content(self):
        ...
        if len(exceptions_to_show) == 1 and self.detailed_view:
            ...
            for exc in exceptions_to_show:
                ...
                table.add_row(
                    timestamp,
                    Text(exc.exception_type, style="red bold"),
                    exc.message
                )
...
class LogPanel(BasePanel, ScrollView):
    ...
    def __init__(self):
        ...
        self.logs = []
        self.log_levels = {"DEBUG": "dim blue", "INFO": "green", "WARNING": "yellow", "ERROR": "red", "CRITICAL": "red bold"}
