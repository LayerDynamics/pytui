...
class StyleManager:
    ...
    # Example calls that use different durations and easings
    await widget.styles.animate('opacity', 0.5, duration=2.0, easing='linear')
    await widget.styles.animate('width', 100, duration=0.5, easing='ease-in')
    await widget.styles.animate('height', 200, duration=1.0, easing='ease-out')
