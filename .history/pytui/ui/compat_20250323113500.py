...
try:
    ...
    class Widget:
        ...
        def focus(self):
            """Focus this widget."""
            if self.parent and hasattr(self.parent, "set_focus"):
        ...
        def styles(self):
            ...
            if not hasattr(self, "_styles"):
                self._styles = _StyleManager(self)
            return self._styles
            
    class _StyleManager:
        """Style manager for compatibility mode."""
        ...
        async def animate(self, property_name, target_value, **kwargs):
            ...
            # In compatibility mode, we just set the value immediately
