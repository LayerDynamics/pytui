...
from .progress import ProgressBarWidgetWidget
...
class ConsoleLogging:
    ...
    async def write(
        self, text: str, style: Optional[Style] = None, level: Optional[str] = None
    ) -> None:
...
class Console(ConsoleBase, ConsoleLogging):
    ...
    ) -> Generator["ProgressBarWidget", None, None]:
        """Create a progress bar context manager."""
        progress_bar = ProgressBarWidget(total=total)
