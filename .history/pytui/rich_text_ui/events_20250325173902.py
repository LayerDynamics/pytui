...
class KeyEvent(Event):
    ...
    name: str  # Required non-default argument
    key: str   # Required non-default argument
    target: Any = None  # Default argument
    prevented: bool = False  # Default argument
    ctrl: bool = False    # Default argument
    alt: bool = False     # Default argument
    shift: bool = False   # Default argument
