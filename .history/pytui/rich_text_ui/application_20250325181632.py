...
class Application:
    ...
    async def run_async(self):
        ...
        try:
            ...
            # Set up key input handler (Unix-like systems)
    ...
    def run(self, close_loop=False):
        """Run the application synchronously.
        
        Args:
            close_loop: Whether to close the event loop after running.
                       Set to False when running multiple applications sequentially.
        """
        ...
        try:
            ...
            if close_loop and not self._loop.is_closed():
                self._loop.close()
