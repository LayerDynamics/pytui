...
def trace_function(frame, event, arg):
    ...
    if event == "call":
        _handle_call_event(frame, arg, frame.f_code.co_name, filename, collector)
        return trace_function
    elif event == "return":
        _handle_return_event(arg, frame.f_code.co_name, collector)
        return trace_function
