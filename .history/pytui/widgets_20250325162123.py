...
try:
    ...
    # Import from our rich_text_ui implementation
    from .ui.rich_text_ui import Static, Text, Panel, Table, Layout, Box

from .ui.widget_utils import CollapsibleMixin, ensure_callable

# Use PascalCase for type variables
TRenderable = TypeVar("TRenderable")
# Get the box style from either rich or our fallback
try:
    from rich.box import ROUNDED
except ImportError:
    from .ui.rich_text_ui import Box
