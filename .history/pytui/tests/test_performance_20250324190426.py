...
@pytest.mark.asyncio
async def test_tracer_function_performance():
    """Test the performance of the trace_function with profiling in a non-blocking manner."""
    
    async def run_profiling():
        def profiling_work():
            # Create a collector and install tracing
