...
def trace_function(frame, event, arg):
    ...
    is_internal = "/pytui/" in frame.f_code.co_filename
    ...
    if event == "call":
        ...
        try:
            if _call_stack and not is_internal:
                COLLECTOR.add_return(frame.f_code.co_name, arg)
        except Exception as e:
            print(f"Error in trace_function return: {e}")
        return None if is_internal else trace_function
