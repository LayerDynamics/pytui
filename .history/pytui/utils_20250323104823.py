    ...
    class DummyProcess:
        ...
        def kill(self):
            ...
            if os_name == 'posix':
                ...
                sys.stderr.write(f"Cannot kill process {self.pid} on {os_name} without psutil\n")  # Using sys to ensure it's used
        ...
        def terminate(self):
            ...
            if os_name == 'posix':
                ...
                sys.stderr.write(f"Cannot terminate process {self.pid} on {os_name} without psutil\n")
    ...
    try:
        ...
        if len(repr_str) > 100:
            ...
            if repr_str.startswith('"') and len(repr_str) > 3:  # Changed from elif to if
                ...
                return repr_str[:96] + "..."
        return repr_str
    except (ValueError, TypeError, RuntimeError):  # Specify exceptions instead of broad Exception
