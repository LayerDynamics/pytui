...
class DataCollector:
    ...
    def add_exception(self, exception, message=None, traceback=None):
        ...
        with self.lock:
            ...
            if traceback is None:
                if hasattr(exception, "__traceback__") and exception.__traceback__:
                    ...
                    tb_lines = tb_module.format_tb(exception.__traceback__)
                else:
                    tb_lines = []
            else:
                tb_lines = (
                    traceback if isinstance(traceback, list) else [str(traceback)]
                )
