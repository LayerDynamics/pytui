...
def _should_skip_file(filename: str) -> bool:
    ...
    # Split path into components and check for pytui component
    path_parts = Path(filename).parts
    return "pytui" in path_parts and not any(p == "tests" for p in path_parts)
...
def trace_function(frame, event, arg):
    ...
    return trace_function if not is_internal else None
