...
class Style:
    ...
    def __init__(self, style_string=""):
        """Initialize style from string or another Style object.

        Args:
            style_string: Space-separated style components (e.g., "bold red") or a Style object
        """
        self.components = set()
        ...
        # Handle Style objects passed to constructor
        if isinstance(style_string, Style):
            self.components = style_string.components.copy()
        # Handle string inputs
        elif isinstance(style_string, str):
